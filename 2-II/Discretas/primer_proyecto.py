...
def tabla(*args):
    ...
    if len(func) == 0:
        ...
        if len(variables) > 10:
            ...
            main_frame = Frame(
                root)  # Pone una nueva Frame para poder utilizar muchos datos y bajar con la barra hacía todos ellos
            ...
            lab = Label(second_frame, text=f"Función:   {transformacion(func).upper()}", bg='#CCC', fg='#000',
            ...
            for j in range(2 ** len(variables)):
                ...
                try:
                    ...
                    messagebox.showerror(
                        message="¡Error en la escritura de la función!\nPor favor ingrese al apartado de ayuda para más información.",
...
def ayuda():
    ...
    l = Label(top, text="El programa puede calcular una tabla de verdad de hasta 10 variables.", fg='#FFF',
              bg='#333333', font=('Garamond bold', 11, 'bold '))
    l.place(x=150, y=100)

    l = Label(top, text="Debe recordar que un parentesis de más o un operador sin variable pueden generar errores.",
              fg='#FFF', bg='#333333', font=('Garamond bold', 11, 'bold '))
    l.place(x=60, y=125)

    l = Label(top, text="A continuación se muestran algunos los ejemplos de cómo se ingresan las funciones booleanas:",
              fg='#FFF', bg='#333333', font=('Garamond bold', 11, 'bold '))
    l.place(x=50, y=150)
    ...
    l = Label(top, text="Ejemplo: (~a+b)*(a+b+c) ó ('a+b).(a+b+c) ", fg='#FFF', bg='#333333',
              font=('Garamond bold', 14, 'bold'))
    l.place(x=250, y=420)
